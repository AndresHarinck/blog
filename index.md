<!-- PAGE WRAPPER (professionele achtergrondkleur) -->
<div style="background:#f2f4f7; min-height:100vh; padding:30px; font-family:Arial, sans-serif;">
...
">
    <h1 style="font-size: 44px; margin-bottom: 10px; font-weight: 600;">
        Welkom op mijn e‑portfolio
    </h1>

    <h3 style="font-size: 22px; font-weight: 300; margin-top: 0;">
        Andres Harinck - Cyber Security Professional
    </h3>

    <p style="max-width: 800px; margin: 25px auto 0; font-size: 18px; line-height: 1.7;">
        Dit e‑portfolio bundelt mijn professionele groei, projecten, stage‑ervaringen en activiteiten binnen de wereld van cybersecurity.
        Hier toon ik wie ik ben als IT’er, waar mijn interesses liggen en hoe ik mij voorbereid op het werkleven.
    </p>
</div>

<!-- SECTION TITLE -->
<h2 style="text-align:center; color:#1e3c72; margin-bottom: 30px; font-size: 28px;">
    Overzicht
</h2>
...
<!-- FOOTER -->
<div style="text-align:center; margin-top:60px; color:#576574; font-size:14px;">
    Gemaakt door Andres Harinck - Toegepaste Informatica (Cyber Security Professional)
</div>
